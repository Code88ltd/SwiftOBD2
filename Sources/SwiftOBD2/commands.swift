...
extension OBDCommand.Mode1 {
    var properties: CommandProperties {
        ...
        case .commandedEGR: return CommandProperties("012C", "Commanded EGR", 3, .percent, true)
        ...
        case .barometricPressure: return CommandProperties("0133", "Barometric Pressure", 3, .pressure, true, maxValue: 255.0)
        ...
        case .ambientAirTemp: return CommandProperties("0146", "Ambient air temperature", 3, .temp, true)
...
case .exhaustGasTempSensor1: return CommandProperties("0198", "Exhaust gas temp sensor", 10, .temp, true)
case .exhaustGasTempSensor2: return CommandProperties("0199", "Exhaust gas temp sensor", 10, .temp, true)
